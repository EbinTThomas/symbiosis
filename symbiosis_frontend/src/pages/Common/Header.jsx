            ...
            >
                ...
                <nav className="right_nav">
                    <div className={`search_bar_container ${!searchActive && "hide"}`}>
                        ...
                        <input type="text" className="search_bar" placeholder="Search for products..." onChange={(e) => setSearchInput(e.target.value)} />
                        {
                            searchInput.length !== 0 && <ul className="search_suggestions">
                                <li>
                                    <Link className="search_suggestion">
                    ...
                    {isAuthenticated &&
                        <a href="" className="open_cart_btn">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    {!isAuthenticated
                        ...
                        : <a className="auth_cred" onClick={toggleAuthNavDropdown}>
                            <span className="auth_username">David Johnson</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
