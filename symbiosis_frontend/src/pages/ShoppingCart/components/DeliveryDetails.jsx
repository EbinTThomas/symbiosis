...
function DeliveryDetails({ handleNext, handleBack }) {
            ...
            <section className="section_delivery_details">
                <div className="delivery_address_wrap">
                    <div className="delivery_address_top">
                        ...
                        <div className="delivery_address_title">Delivery Address<p>We will deliver your order to this address</p></div>
                    </div>
                    <div className="delivery_address_content">
                        {addressFilled ? <>
                            ...
                            : <>
                                <div className="empty_class">No Address Added Yet!</div>
                            </>
                        }
                        <button className="toggle_address_btn" onClick={handleToggleForm}>
                            {addressFilled ? <>Change Address</> : <>Add Address</>}
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                ...
                <OrderDetails cartList={cartList} handleNext={handleNext} btn_label={"Proceed To Payment"} />
