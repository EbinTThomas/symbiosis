...
function SectionProductDetail() {
    ...
    const productDetail = {
        "name": "CurQmeg-3",
        "desc": "Boost your immune system with our all-natural immunity powder, packed with essential vitamins and nutrients to help you stay healthy year-round.",
        "price": 300,
        "unit": "SAR"
    }
    return (
        <div className="product_details_container">
            <div className="img_slider_container">
                ...
                <img src="../assets/img/bottle.png" alt="" className="product_thumbnail" />
            </div>
            <div className="product_details">
                <h3 className="product_name">{productDetail.name}</h3>
                <p className="product_desc">{productDetail.desc}</p>
