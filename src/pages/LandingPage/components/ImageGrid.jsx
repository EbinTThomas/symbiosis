...
import '../../../static/styles/ImageGrid.css';
...
function ImageGrid({ items }) {
    ...
    return (
        items.map((item) => (
            item.image
                ? <img src={item.get_image} alt="" className="ad_grid_image" />
                : item.product
                    ? <div to={`/product_detail/${item.product.id}`} className="product_card" key={item.product.id}>
                        ...
                        <Link to={item.brand ? `/brand/${item.brand}` : item.product && `/product_detail/${item.product.id}`}>
                            ...
                            <div className="product_details">
                                ...
                                <div className="product_brand_name">{item.product.brand.name}</div>
                                ...
                                <div className="product_price">
                                    {
                                        ...
                                        && <>
                                            <span className="off_percent">-{item.product.discount}%</span>
                                            <span className="product_org_price">{formatIndianRupee(item.product.price)}</span>
                                        </>
                                    }{calculateDiscount(item.product.price, item.product.discount)}</div>
                            </div>
                        </Link>
                    </div>
                    : null
